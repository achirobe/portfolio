        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <svg className="w-6 h-6 text-indigo-600 dark:text-indigo-400 mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div>
                    ...
                    <br />
                    <a href={`mailto:${personalInfo.emailAlt}`} className="text-indigo-600 dark:text-indigo-400 hover:underline text-sm">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`tel:${personalInfo.phone}`} className="text-indigo-600 dark:text-indigo-400 hover:underline">
                      {personalInfo.phone}
                    </a>
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-indigo-600 to-blue-600 rounded-lg shadow-xl p-8 text-white">
                <h3 className="text-2xl font-bold mb-4">
                  Let's Collaborate!
                </h3>
                <p className="mb-6">
                  I'm always open to discussing research opportunities, collaborations, or innovative projects in thermal-fluid systems and machine learning.
                </p>
                <a 
