      ...
      <div className="container mx-auto px-4 py-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <h2 className="text-2xl md:text-3xl text-indigo-600 dark:text-indigo-400 mb-4">
              {personalInfo.title}
            </h2>
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <a 
                ...
                download
                className="px-8 py-3 bg-white dark:bg-gray-800 text-indigo-600 dark:text-indigo-400 border-2 border-indigo-600 rounded-lg hover:bg-indigo-50 dark:hover:bg-gray-700 transition-colors shadow-lg"
              >
                Download CV
              </a>
            </div>
