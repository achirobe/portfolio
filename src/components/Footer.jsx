        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#research" className="text-gray-400 hover:text-indigo-400 transition-colors">
                  Research
                </a>
              </li>
              <li>
                <a href="#publications" className="text-gray-400 hover:text-indigo-400 transition-colors">
                  Publications
                </a>
              </li>
              <li>
